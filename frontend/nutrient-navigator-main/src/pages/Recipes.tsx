...
const Recipes = ({
  ...
  useEffect(() => {
    const fetchRecipes = async () => {
      try {
        ...
        const transformed: Recipe[] = await Promise.all(
          foods.map(async (food, index) => {
            ...
            return {
              ...
              image: imageUrl,
              prepTime: "25 min", // placeholder until backend supports it
              servings: 2,
              calories: 400,
              nutrients: [food.mainNutrition, ...(food.tags || [])].filter(
                Boolean
              ),
              category:
  ...
  const filteredRecipes = recipes.filter((recipe) => {
    ...
    const matchesPrepTime =
      selectedPrepTime === null || prepMinutes <= selectedPrepTime;
        ...
        <section className="pt-28 pb-12 gradient-hero">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-muted-foreground">
              Browse meals and filter by prep time
            </p>
                  ...
                  >
                    <div className="relative h-48">
                      ...
                      <Heart
                        ...
                        stroke={
                          favorites.includes(recipe.id) ? "pink" : "white"
                        }
                        fill={
                          favorites.includes(recipe.id) ? "pink" : "none"
                        }
                        onClick={(e) => {
                          e.stopPropagation();
                          setFavorites((prev) =>
